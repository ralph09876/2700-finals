<?php
  ...
  * Slug: furnitrix/footer-three-columns
  * Categories: furnitrix, footer
  */
?>
			...
			<div class="wp-block-columns wp-block-footer-widget-area-columns">
				...
				<div class="wp-block-column wp-block-widget">
					...
					<div class="wp-block-group">
						...
						<!-- /wp:heading -->
						<!-- wp:paragraph -->
						<p><?php esc_html_e ( 'Commerce WordPress theme with pixel perfect design and extensive functio-nality to create your very own profess-ional and unique online store.', 'furnitrix' ) ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
				...
				<div class="wp-block-column wp-block-widget">
					...
					<div class="wp-block-group">
						...
						<h2 id="contact" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e ( 'Useful Links', 'furnitrix' ) ?></h2>
						<!-- /wp:heading -->
						<!-- wp:navigation /-->
					</div>
					<!-- /wp:group -->
				...
				<div class="wp-block-column wp-block-widget">
					...
					<div class="wp-block-group">
						<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
						<h2 id="contact" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e ( 'My Account', 'furnitrix' ) ?></h2>
						<!-- /wp:heading -->
						<!-- wp:navigation /-->
					</div>
					<!-- /wp:group -->
