<?php
  ...
  * Slug: furnitrix/featured-content
...
<div class="wp-block-group alignfull wp-block-section wp-block-feature-content">
	...
	<div class="wp-block-group wp-block-group-heading">
		...
		<h2 class="wp-block-heading has-text-align-center"> <?php esc_html_e ( 'Featured Contents', 'furnitrix' ) ?></h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"> <?php esc_html_e ( 'Modern Furniture from Famous Manufacturers and Designers Offering the Finest Furnishings for Every Room of Your Home or Office', 'furnitrix' ) ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
