<?php
  ...
  * Slug: furnitrix/header-transparent
  * Categories: furnitrix, header
  */
?>

<!-- wp:group {"align":"full","className":"social-and-toggle-search header-transparent","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull social-and-toggle-search header-transparent">
