...
<div class="wp-block-group alignfull no-margin-top header-media-inner-post">
	...
	<div class="wp-block-group alignfull" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
		<!-- wp:cover {"url":"<?php echo get_parent_theme_file_uri( '/assets/images/inner-header-media.jpg' ); ?>","dimRatio":50,"overlayColor":"body-text","focalPoint":{"x":"0.52","y":"0.00"},"isDark":false} -->
		<div class="wp-block-cover is-light">
			<span aria-hidden="true" class="wp-block-cover__background has-body-text-background-color has-background-dim-50 has-background-dim"></span>
			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
                 ...
                 <h1 class="has-text-align-center has-background-color has-text-color"><?php esc_html_e ( '404 Nothing Found', 'furnitrix' ) ?></h1>
                  <!-- /wp:heading -->
                  <!-- wp:paragraph {"textAlign":"center"} -->
                  <p class="has-text-align-center has-background-color has-text-color"><?php esc_html_e ( 'Oops! That page can\'t be found', 'furnitrix' ) ?></p>
                  <!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
