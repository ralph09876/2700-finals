...
<div class="wp-block-group alignfull no-margin-top header-media-inner-post">
	...
	<div class="wp-block-group alignfull" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
		<!-- wp:cover {"url":"<?php echo get_parent_theme_file_uri( '/assets/images/inner-header-media.jpg' ); ?>","dimRatio":50,"overlayColor":"body-text","focalPoint":{"x":"0.52","y":"0.00"}} -->
		<div class="wp-block-cover">
			<span aria-hidden="true" class="wp-block-cover__background has-body-text-background-color has-background-dim"></span>
			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group alignwide">
						<!-- wp:heading {"textAlign":"center","level":1,"textColor":"background","className":"wp-block-post-title"} -->
						<h1 class="wp-block-heading has-text-align-center wp-block-post-title has-background-color has-text-color"><?php esc_html_e ( 'Recent From Blog', 'furnitrix' ) ?></h1>
						<!-- /wp:heading -->
					</div>
					<!-- /wp:group -->
				</div>
